      ...
      map(({ summary, shopKpis }) => {
        ...
        return {
          ...
          kpiTotalShops: {
            ...
            linkText: 'Boutiques actives',
          },
          kpiPendingShops: {
            title: 'Nombre de boutiques en attente',
            percent: Number(shopKpis.totalPendingShops ?? 0),
            subtitle: `${Number(shopKpis.totalRejectedShops ?? 0)} rejetees`,
            linkText: 'Boutiques en attente',
          },
          kpiBannedShops: {
            title: 'Nombre de boutiques suspendues',
            percent: Number(shopKpis.totalSuspendedShops ?? 0),
            subtitle: `${Number(shopKpis.totalSuspendedShops ?? 0)} suspendues`,
            linkText: 'Boutiques suspendues',
          },
